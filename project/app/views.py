...
def store(request):
    if request.method=="POST":
        ...
        student = Student(sid=sid, username=username,fname=fname ,lname=lname,email=email,phone_number=phone_number,pass1=pass1,pass2=pass2)
        student.save()
...
def login_check(request):
    ...
    auth_token = "a5907ca0d1186404176832e60a802fdf" 
